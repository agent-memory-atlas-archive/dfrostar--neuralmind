        ...
        <>
            ...
            <main className="pt-32 pb-20 px-4 md:px-6">
                <article className="max-w-3xl mx-auto">
                    ...
                    <p className="text-slate-300 text-lg mb-4">NeuralMind is local-first: your code, your decisions, your data. No code leaves your machine, no telemetry, no third-party analytics.</p>
